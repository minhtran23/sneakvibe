        ...
        <div class="banner-main__content">
            <div class="item">
                <a href="javascript:void(0);" class="d-block">
                    <img src="{{asset('/front_end/img/bn/1.png')}}" alt="2">
                </a>
            </div>
            <div class="item">
                <a href="javascript:void(0);" class="d-block">
                    <img src="{{asset('/front_end/img/bn/2.png')}}" alt="1">
                </a>
            </div>
             <div class="item">
                <a href="javascript:void(0);" class="d-block">
                    <img src="{{asset('/front_end/img/bn/3.png')}}" alt="1">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container-pre">
        ...
        <div class="row-pre new-product">
           ...
           <div class="product-item__image position-relative">
               ...
               @if ($list->product_promotion != 0)
               <div class="sale position-absolute text-center" style="z-index:1;">
           ...
           <div class="product-item__infor text-center">
               ...
               <a href="/chi-tiet-giay/{{$list->product_slug}}"
                  ...
                  @if ($list->product_promotion == 0)
                       <p class="m-0">
                  <span
                       class="d-inline-block price font-weight-bold tp_product_detail_priceprice-sale">{{number_format($list->product_price,0,',')}}&#8363</span>
               </p>
                   @else
                       <p class="m-0">
        ...
        <div class="text-center pt-4">
            <a href="/tat-ca-giay" class="d-inline-block font-weight-bold see-more">
