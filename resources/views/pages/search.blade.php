...
<div class="container-pre product-page tp_product_category">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between">
        ...
        <div class="find-basic d-flex align-items-center justify-content-center">
            ...
            <form action="">
            @csrf
            <select class="sort-by custom-dropdown__select custom-dropdown__select--white px-2 d-inline-block" id="sort">
                <option selected value="{{Request::url()}}?sort_by=none">
                ...
                <option value="{{Request::url()}}?sort_by=kytu_az">
                    Thứ tự theo tên: A-Z </option>
                <option value="{{Request::url()}}?sort_by=kytu_za">
                    Thứ tự theo tên: Z-A </option>
            </select>
            </form>
            ...
            <div class="row-pre">
                ...
                <div class="col-12">
                    {{-- <div class="paginator"><span class="labelPages">1 - 4 / 4</span><span
                            ...
                            {{$timkiem->onEachSide(2)->appends(Request::query())->links() }}
