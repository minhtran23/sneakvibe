            ...
            <form action="{{route('add.cart')}}" method="post">
                ...
                <div class="d-flex align-items-center py-2 mb-3 group-buy">
                    ...
                    <div class="purchase-product">
                        <button class="add-to-cart btn-outline  btn font-weight-bold text-uppercase" type="submit">
                         Thêm vào giỏ hàng
                        </button>
                        <button
                            class="quick-to-cart btn-outline  btn font-weight-bold text-uppercase">
                            Mua ngay
                        </button>
            ...
            <div class="content-tab">
                    ...
                    <div class="d-flex justify-content-center row">
                        <div class="col-md-12">
                            <div class="d-flex flex-column comment-section">
                                @if (auth('cus')->check())
                                   <form action="/comment/{{$product_detail->id}}" method="POST">
                                    ...
                                    <div class="bg-light p-2">
                                        <div class="d-flex flex-row align-items-start"><img class="rounded-circle" src="{{asset('/front_end/img/customer.jpg')}}" width="60">
                                ...
                                @else
                                  <div class="alert alert danger" role="alert">
                                    <strong>Đăng nhập để bình luận</strong> click vào đây <a href="{{route('account.login')}}">Đăng Nhập</a>
                                  </div>
                                @endif
                               ...
                               <div class="bg-white p-2">
                                <div class="d-flex flex-row user-info"><img class="rounded-circle" src="{{asset('/front_end/img/customer.jpg')}}" width="51.2">
                                    <div class="d-flex flex-column justify-content-start ml-2">
                                        <?php
                                        $customer = \App\Models\tbl_customers::where('id',$com->customer_id)->get();  
                                        ?>
                            ...
                            {{-- @if (Gate::allows('my-comment', $com))
                                <div class="bg-white">
                                    <div class="d-flex flex-row fs-12">
                                        <div class="like p-2 cursor"><span class="ml-1">Sửa</span></div>
                                        <div class="like p-2 cursor"><span class="ml-1">Xóa</span></div>
                                    </div>
                                </div>
                           @endif --}}
