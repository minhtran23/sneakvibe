...
use App\Http\Controllers\HistoryCotroller;
...
Route::get('/tat-ca-giay',[myController::class, 'giay']);
Route::get('/chi-tiet-giay/{slug}',[myController::class,'giayChiTiet']);

Route::get('/timkiem',[myController::class,'timkiem']);
Route::post('/timkiem',[myController::class,'timkiem']);

Route::get('/blog',[myController::class,'blog']);
Route::get('/chi-tiet-blog/{slug}',[myController::class,'blogChiTiet']);

Route::post('/comment/{product_id}',[myController::class,'comment'])->name('comment');
...
Route::get('/lich-su-mua-hang/don-hang-chi-tiet/{order}', [HistoryCotroller::class, 'order_history'])->name('order_history');
...
// Quản lý bình luận
// Quản lý bình luận
Route::get('/admin/quan-ly-binh-luan',[CommentController::class,'index']);
Route::get('/admin/quan-ly-binh-luan/xoa/{id}',[CommentController::class,'delete']);
// Quản lý đơn hàng
